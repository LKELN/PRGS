...
def parse_arguments():
    ...
    parser.add_argument("--rerank_batch_size", type=int, default=8,
                        help="Batch size for inference (caching and testing)")
    parser.add_argument("--learn_adj", action="store_false", help="determine whether to learn the adjacency matrix")
    parser.add_argument("--pool", type=str, default=["c","sc2","sc1"], help="pool mode for patch")
    parser.add_argument('--ws', type=int, default=4, 
                        help="kernelsize for extract patch")
    ...
    parser.add_argument('--norerank', type=int, default=0,
                        help='use fixed rerank model')
    ...
    parser.add_argument("--neg_hardness", type=int, default=20,
    ...
    parser.add_argument("--num_local", type=int, default=1200,
                        help="number of local features")
    parser.add_argument("--num_local_nomask", type=int, default=1000,
                        help="number of local features no mask")
    parser.add_argument("--mining", type=str, default="partial",
                        choices=["partial", "full", "random", "msls_weighted", 'global', 'global_combine'])
    # Model parameters
    parser.add_argument("--backbone", type=str, default="deit",
    ...
    parser.add_argument("--aggregation", type=str, default="gem",
                        choices=["netvlad", "gem", "spoc", "mac", "rmac", "crn", "rrm",
                                 "cls", "seqpool", "none"])
    ...
    # Paths parameters
    parser.add_argument("--datasets_folder", type=str, default="/opt/data/private", help="Path with all datasets")
    parser.add_argument("--dataset_name", type=str, default="Pittsburgh30k", help="Relative path of the dataset")
    parser.add_argument("--pca_dataset_folder", type=str, default=None,
                        help="Path with images to be used to compute PCA (ie: pitts30k/images/train")
    parser.add_argument("--save_dir", type=str, default="global_retrieval",
