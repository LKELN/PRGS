...
def parse_arguments():
    ...
    # Paths parameters
    parser.add_argument("--datasets_folder", type=str, default=r"W:\vpr_dataset", help="Path with all datasets")
    ...
    if args.mining == "msls_weighted" and args.dataset_name != "msls.json":
        raise ValueError(
            "msls_weighted mining can only be applied to msls.json dataset, but you're using it on {args.dataset_name}")
