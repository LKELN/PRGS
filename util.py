...
def resume_train(args, model, optimizer=None, strict=False):
    ...
    # state_dict["module.Reranker.classifier.0.weight"]=model_dict["module.Reranker.classifier.0.weight"]
    # state_dict["module.Reranker.classifier.0.bias"] = model_dict["module.Reranker.classifier.0.bias"]
