...
def scan_training(args):
    ...
    #===================================================================
#     args.backbone = 'deit'
#     args.resume = '/opt/data/private/RegionGCN/logs/GCNrerank_MSLS_finetune_2023-11-24_09-51-44/best_model.pth'
    #===================================================================
...
def compute_mining(args):
    args.backbone = 'resnet50' #'resnet50' #
