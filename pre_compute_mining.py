...
def scan_training(args):
    ...
    #===================================================================
    args.backbone = 'deit'
    args.resume = '/home/flztiii/llg/R2Former/logs/global_retrieval/best_model.pth'
    #===================================================================
...
class Args():
    def __init__(self):
        ...
        self.datasets_folder = "/media/flztiii/7320bc0c-a136-44a4-86f2-0ffc2c3b3a9a/llg_vpr_dataset"
        self.negs_num_per_query = 1
        self.dataset_name = 'Pittsburgh30k'
        self.infer_batch_size = 160
        self.resume = ''
